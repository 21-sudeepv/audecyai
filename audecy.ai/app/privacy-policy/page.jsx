    ...
    <>
      ...
      <div className="faq-container" style={{ maxWidth: '1000px' }}>
        <div className="legal-content" style={{ color: 'var(--smoke)', lineHeight: '1.8', fontSize: '1rem', fontWeight: '300' }}>
          ...
          <p style={{ marginTop: '16px' }}><strong>Frequency of screening.</strong> Screening is repeated periodically for continuing relationships and whenever we become aware of a material change in ownership or control.</p>
          <p style={{ marginTop: '16px' }}><strong>Outcomes and escalation.</strong> Where a match is confirmed, the transaction is stopped and, where required, reported to the relevant authority.</p>
